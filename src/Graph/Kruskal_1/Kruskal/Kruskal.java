package Graph.Kruskal_1.Kruskal;
...
public class Kruskal {
    ...
    public static void main(String args[]) {
        System.out.println("Running [Graph.Kruskal] - 2000");
//        if (args.length != 1) {
//            System.out.println("Usage: java Graph.Kruskal <fileName>");
//            System.exit(0);
//        }
        Kruskal k = new Kruskal();
        String fileName = "1.txt";
        k.readInGraphData(fileName); //в скобках было args[0]
        k.performKruskal();
        k.printFinalEdges();
    }
    Kruskal() {
