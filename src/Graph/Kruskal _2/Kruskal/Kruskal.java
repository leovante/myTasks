...
/*
 * This program runs an empirical test of Graph.Kruskal's minimum spanning
 ...
 *
 * The program generates these graphs and runs Graph.Kruskal's minimum spanning
...
public class Kruskal {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.println("Usage: java Graph.Kruskal <seed> <number of vertices>");
      return;
    }
   ...
   * tree using Graph.Kruskal's algorithm.
   */
   ...
   * graph's minimum spanning tree using Graph.Kruskal's algorithm.
   */
